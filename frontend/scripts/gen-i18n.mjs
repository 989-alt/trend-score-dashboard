...
const ko = {
  ...
  "news.layer.domestic": "국내 종목",
  "news.layer.us": "미국 종목",
  "news.layer.macro": "종합 이슈",
  "news.layer.empty": "이 레이어 이슈 없음",
  ...
  "trading.title": "모의 매매 현황(전진검증)",
  "trading.running": "가동 중",
  "trading.stopped": "정지",
  ...
  "trading.navCurve": "누적 수익률",
  "trading.empty": "아직 매매 기록이 없습니다.",
  "trading.col.ticker": "종목",
  "trading.col.qty": "수량",
  "trading.col.avgPrice": "평단",
  "trading.col.curPrice": "현재가",
  "trading.col.pnl": "평가손익",
  "trading.col.time": "시각",
  "trading.col.side": "구분",
  "trading.col.reason": "사유",
  "trading.side.buy": "매수",
